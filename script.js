function show(cupcakeId) {
    ...
    // let characterChanged = document.getElementById("character_changed");
    ...
    if (cupcakeId === "cupcake1") {
        ...
        // secondImage.height = '200px';
        // secondImage.marginBottom = '400px';
        ...
        secondImage.style.marginTop = '400px';
        show("character_standard");
        //keep doing this! margin left for each one
     ...
     characterImage.style.marginTop = '200px';
      ...
      //   characterStandard.style.display = 'none';
      //   characterChanged.style.display = 'block';
      // } else if (cupcakeId === "character_standard") {
      //   characterStandard.style.display = 'block';
      //   characterChanged.style.display = 'none';
      // }
...
document.getElementById("cupcake1").addEventListener("click", function() {
    show("cupcake1");
    //add if statement for music here
});
